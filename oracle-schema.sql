...
CREATE TABLE DimBroker  ( SK_BrokerID  NUMBER(11,0) PRIMARY KEY,
							...
							Office       CHAR(50),
							Phone       CHAR(14),
							IsCurrent NUMBER(1,0) NOT NULL CHECK (IsCurrent = 0 OR IsCurrent = 1),
...
CREATE TABLE DimCompany (   SK_CompanyID NUMBER(11,0) PRIMARY KEY, 
							...
							SPrating CHAR(4),
							isLowGrade NUMBER(1,0) NOT NULL CHECK (isLowGrade = 0 OR isLowGrade = 1),
...
CREATE TABLE DimTrade (	TradeID NUMBER(11,0) Not NULL,
						...
						CashFlag NUMBER(1,0) NOT NULL CHECK (CashFlag = 0 OR CashFlag = 1),
...
CREATE TABLE Prospect ( AgencyID CHAR(30) NOT NULL UNIQUE,  
						...
						BatchID NUMBER(5) NOT NULL,
						IsCustomer NUMBER(1,0) NOT NULL CHECK (IsCustomer = 0 OR IsCustomer = 1),
						LastName CHAR(30) NOT NULL,
						FirstName CHAR(30) NOT NULL,
						MiddleInitial CHAR(1),
						Gender CHAR(1),
