...
CREATE TABLE DimCompany (   SK_CompanyID NUMBER(11,0) PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY, 
...
CREATE TABLE DimSecurity( SK_SecurityID NUMBER(11,0) PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
