...
CREATE TABLE DimBroker  ( SK_BrokerID  NUMBER(11,0) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE DimCustomer  ( SK_CustomerID  NUMBER(11,0) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE DimAccount  ( SK_AccountID  NUMBER(11,0) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE DimCompany (   SK_CompanyID NUMBER(11,0) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, 
							CompanyID NUMBER(11,0) NOT NULL,
							Status CHAR(10) Not NULL, 
							Name CHAR(60) Not NULL,
							Industry CHAR(50) Not NULL,
							SPrating CHAR(4),
							isLowGrade CHAR(5) NOT NULL CHECK (isLowGrade = 'true' OR isLowGrade = 'false' or isLowGrade = 'NULL'),
...
CREATE TABLE DimSecurity( SK_SecurityID NUMBER(11,0) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
